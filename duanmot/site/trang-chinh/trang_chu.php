<div class="site-wrap">
    <?php
    require 'trang-chinh/banner.php';
    ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                    <a class="block-2-item" href="#">
                        <figure class="image">
                            <img src="<?= $content ?>images/code-complete-2.png" alt="" class="img-fluid" width="753px" height="
                            753px" >
                        </figure>
                        <div class="text">
                            <span class="text-uppercase">Collections</span>
    ...
    <?php
    require 'trang-chinh/noi_bat.php';
    ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7 mb-5">
                    <a href="#"><img src="<?= $content ?>images/bigsale.jpg" alt="Image placeholder"
                            class="img-fluid rounded" width="800px"></a>
                </div>
