<<<<<<< HEAD
  ...
  <div class="site-wrap">
      <div class="bg-light py-3">
          <div class="container">
              <div class="row">
                  <div class="col-md-12 mb-0"><a href="index.html">Trang chủ</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Tin Tức</strong></div>
              </div>
          </div>
      </div>
      <h1>Tin tức</h1>
...
<div class="site-wrap">
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="http://duan-1.php/site/index.php/?pages=trang-chinh&action=trang_chu">Trang chủ</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Tin Tức</strong></div>
            </div>
        </div>
    </div>
    <h1>Tin tức</h1>
