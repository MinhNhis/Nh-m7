            ...
            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
              <div class="block-4 text-center border">
                <figure class="block-4-image">
                  <a href="http://da1/site/index.php/?pages=trang-chinh&action=chi-tiet"><img
                      src="<?= $content ?>images/product.webp" alt="Image placeholder" class="img-fluid"></a>
                </figure>
                <div class="block-4-text p-4">
                  <h3><a href="http://da1/site/index.php/?pages=trang-chinh&action=chi-tiet">Book</a></h3>
                  <p class="mb-0">Book</p>
        ...
        <div class="col-md-3 order-1 mb-5 mb-md-0">
          <div class="border p-4 rounded mb-4">
            ...
            <ul class="list-unstyled mb-0">
              <li class="mb-1"><a href="#" class="d-flex"><span>Truyện tranh</span> <span
                    class="text-black ml-auto">(2,220)</span></a></li>
              <li class="mb-1"><a href="#" class="d-flex"><span>Kinh tế</span> <span
                    class="text-black ml-auto">(2,550)</span></a></li>
              <li class="mb-1"><a href="#" class="d-flex"><span>Giáo dục</span> <span
