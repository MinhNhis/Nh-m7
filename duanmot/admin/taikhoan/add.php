<div class="card">
    ...
    <form action="index.php?act=add-user" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        <!-- <div class="mb-3">
            ...
            <input type="text" name="id" id="id" placeholder="" disabled class="form-control" aria-describedby="">
        </div> -->
        <div class="mb-3">
            <label for="" class="form-label">User</label>
            <input type="text" class="form-control" name="user" id="user" placeholder="Nhập vào tên">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="tel" id="tel" placeholder="Nhập vào sđt">
        </div>
        <div class="mb-3">
        ...
        <button type="submit" name="btn-add" class="btn btn-primary">Thêm Kh</button>
