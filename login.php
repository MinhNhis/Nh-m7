    ...
    <div class="box_content form_account">
        ...
        if (isset($_SESSION['user'])) {
            ...
            <div class="card text-center">
                <div class="card-body">
                    <h4 class="card-title">
                        Xin Chào <?php echo $_SESSION['user']['user'] ?>
                    </h4>
                    <p class="card-text">
                    <div class="text-left">
                        <ul>
                            <!-- <li class="form_li"><a href="index.php?act=edit-account">Chỉnh sửa tài khoản</a></li> -->
                            <li class="form_li"><a href="?pages=trang-chinh&action=cart">Giỏ hàng</a></li>
                            <li class="form_li"><a href="?pages=trang-chinh&action=my-bill">Đơn hàng của tôi</a></li>
